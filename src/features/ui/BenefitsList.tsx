...
function BenefitsList() {
    return (
        <div className="space-y-3">
               ...
               <Benefit icon={<IoStorefrontOutline className="size-9" /> } title='DaSA Market Center' description="Gain exclusive access to the DaSA Marketplace, where you can showcase your business, connect with fellow entrepreneurs, and grow within a supportive community."/> 
            </div>
    )
}
