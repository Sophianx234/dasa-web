...
function BriefAbout() {
    return (
        <div className="flex justify-center flex-col items-center py-14 space-y-2 px-4 border-b-dasalight border-b-2 ">
            ...
            <Link to='/homepage/about' className="bg-dasalight px-3 py-2 rounded-2xl font-semibold text-[rgb(51,49,46)] text-sm flex items-center gap-2 hover-primary">Read More
            <FaArrowRight/>
            </Link>
            </div>
        </div>
