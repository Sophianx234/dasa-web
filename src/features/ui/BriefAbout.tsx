...
function BriefAbout() {
    return (
        <div className="flex justify-center flex-col items-center py-6 px-4 border-b-primary border-b-2 ">
            ...
            <button className="bg-primary px-3 py-2 rounded-2xl font-semibold text-[#33312e] text-sm flex items-center gap-2">Read More
            <FaArrowRight/>
            </button>
            </div>
        </div>
