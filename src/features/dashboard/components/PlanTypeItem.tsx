    ...
    return (
        <div>
            <div className="">
                ...
                pb-2
                ">
                    <div className="grid grid-cols-[1fr_1fr_2.5fr] items-center pt-2 pb-2 ">
                    ...
                    <GiReceiveMoney className="fill-dasadeep"/> <p>{planPackage} </p>
                    </div>
                    ...
                    <div className="text-smfont-poppins  grid grid-cols-[.2fr_2fr] ">
                        <div></div>
                    <p className="text-sm font-mulish  ">{planDesc}</p>
                    </div>
                </div>
            </div>
        </div>
