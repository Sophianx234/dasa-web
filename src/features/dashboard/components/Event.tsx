    ...
    return (
        ...
        <div className="grid grid-cols-1  border-dasalight border-2 mx-4 shadow-lg pb-6 rounded-lg">
            ...
            <div className="space-y-2">
                    <p className="bg-dasalight h-fit w-fit px-4 text-lg py-2 font-Montserrat font-semibold">latest</p>
                ...
                <div className="space-y-2 pl-2 pb-2">
                    ...
                    <p className="flex items-center  text-sm gap-1 font-poppins font-semibold"><MdOutlineLocationOn className="size-7"/> <span>Tamale</span></p>
                </div>
            </div>
        </div>
        </>
